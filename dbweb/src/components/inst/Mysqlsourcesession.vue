    ...
    <el-row>
      <el-col :span="24">
        <el-table :data="resourceSessionTableData" stripe border
          ...
          <el-table-column prop="max_connect" label="可用最大连接" ></el-table-column>
          <el-table-column prop="max_connect_used" label="已用最大连接数"></el-table-column>
        </el-table>
      </el-col>
    </el-row>
  </div>
          ...
          this.flag = false,
            ...
            this.$http.get('/api/inst/getmlinfo/', {
              params: {
                ...
                this.resourceSessionTableData = res.result.info_session
